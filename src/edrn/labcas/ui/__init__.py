...
def main(global_config, **settings):
    ...
    config.add_route('target', '/upload/{workflowID}', factory=Upload)
    config.add_route('metadata', '/upload/{workflowID}/{collectionID}', factory=Upload)
    config.add_route('accept', '/upload/{workflowID}/{collectionID}/accept', factory=Upload)
