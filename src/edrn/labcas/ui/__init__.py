...
def main(global_config, **settings):
    ...
    config.add_route('collections', '/', factory=Collections)
    config.add_route('collection', '/{collectionID}', factory=Collection)
    config.add_route('dataset', '/{collectionID}/{datasetID}', factory=Dataset)
    config.add_route('file', '/{collectionID}/{datasetID}/{fileID}', factory=File)
